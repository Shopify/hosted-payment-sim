...
As soon as you are confident that your implementation is complete, please send another email to payment-integrations@shopify.com with the following details:
  ...
  + Screenshots of payment flow for both successful and failed payment attempts
  + Setup steps for merchants that would like to configure your gateway with their store
